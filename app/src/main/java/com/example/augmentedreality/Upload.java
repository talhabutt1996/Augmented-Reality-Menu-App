...
public class Upload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_name = (EditText)findViewById(R.id.txt_dish_name);
    ...
    public void uploadImage(){
        ...
        StorageReference storageReference = FirebaseStorage.getInstance()
                .getReference().child("Recipe").child(uri.getLastPathSegment());

        final ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Dish Uplading.... :)");
        progressDialog.show();
    ...
    public void btnUploadDish(View view) {
        ...
        FirebaseDatabase.getInstance().getReference("Recipe")
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(Upload.this, "Dish Uploaded", Toast.LENGTH_SHORT).show();
                    finish();
